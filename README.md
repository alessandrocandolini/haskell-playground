...
* type-driven development, business, domain and system modelling through types, and usage of the types to explore the model and reason about it (eg, through ADTs and pure functions, but not only)
